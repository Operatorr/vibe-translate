...
The user usually runs `pnpm dev:full` in another terminal window. Do not ask to start another dev server for localhost verification; use the already-running server when possible.
